...
export default function Hero() {
  return (
    <section 
      className="relative w-full h-[100svh] overflow-hidden flex items-center justify-center bg-gradient-to-br from-primary/10 via-vibrant-pink/10 to-secondary/10"
    >
      <div className="container relative z-10 mx-auto flex flex-col items-center justify-center text-center gap-8 px-5">
        <div className="animate-fade-in-down flex flex-col items-center" style={{animationDelay: '0.2s'}}>
            ...
            <Image
                ...
                priority
            />
            <p className="mx-auto mt-6 max-w-xl text-base text-foreground/80 md:text-xl font-medium leading-relaxed drop-shadow-sm">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up" style={{animationDelay: '0.6s'}}>
            ...
            <Button asChild size="lg" variant="outline" className="border-2 border-foreground/30 bg-white/20 backdrop-blur-sm text-foreground font-bold hover:bg-white/30 rounded-full px-8 py-7 text-lg transition-all w-full sm:w-auto">
