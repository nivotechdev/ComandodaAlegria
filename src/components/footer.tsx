...
import { Instagram, Sparkles, Facebook, Heart } from 'lucide-react';
      ...
      <div className="container mx-auto px-5 grid md:grid-cols-3 gap-12 items-start justify-center text-center md:text-left relative z-10 pb-16">
        ...
        <div className="flex flex-col items-center md:items-start gap-4">
            ...
            <ul className="space-y-2">
                ...
                <li><Link href="#about-us" className="font-semibold text-foreground/80 hover:text-accent transition-colors">Sobre Nós</Link></li>
            </ul>
        </div>
