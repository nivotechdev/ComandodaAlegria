...
export default function Footer() {
  return (
    <footer id="contact" className="bg-primary text-primary-foreground w-full pt-24 relative overflow-hidden">
       <div className="absolute top-0 left-0 w-full text-card overflow-hidden leading-none transform rotate-180">
      ...
      <div className="container mx-auto px-4 md:px-6 grid md:grid-cols-3 gap-12 items-start justify-center text-center md:text-left relative z-10 pb-16">
        ...
        <div className="flex flex-col items-center md:items-start gap-4">
             <Link href="/" className="flex flex-shrink-0 items-center gap-3">
                ...
                <span className="font-headline text-3xl font-bold text-card">
                Comando da Alegria
                </span>
            </Link>
            <p className="text-card/80 max-w-xs">
                Transformando sua festa em um evento inesquecível com a magia que encanta.
            </p>
        </div>
        
        <div className="flex flex-col items-center md:items-start gap-4">
            <h3 className="font-headline text-2xl font-bold text-card">Mapa da Diversão</h3>
            <ul className="space-y-2">
                <li><Link href="#characters" className="text-card/80 hover:text-accent transition-colors font-medium">Personagens</Link></li>
                <li><Link href="#services" className="text-card/80 hover:text-accent transition-colors font-medium">Serviços</Link></li>
                <li><Link href="#coverage" className="text-card/80 hover:text-accent transition-colors font-medium">Área de Atendimento</Link></li>
                <li><Link href="#contact" className="text-card/80 hover:text-accent transition-colors font-medium">Fale Conosco</Link></li>
            </ul>
        </div>
        
        <div className="flex flex-col items-center md:items-start gap-4">
            <h3 className="font-headline text-2xl font-bold text-card">Redes Encantadas</h3>
