      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="mx-auto grid grid-cols-2 gap-6 pt-12 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          {characters.map((character, index) => (
            <Card key={character.id} className={`group overflow-hidden rounded-3xl border-4 bg-background transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 hover:rotate-[-2deg] ${borderColors[index % borderColors.length]}`}>
